...
![layered net](https://github.com/hchiam/machineLearning/blob/master/layeredNet.jpgg "a layered neural network with two input neurons, two hidden neurons, and one output neuron for the 'guess'")
